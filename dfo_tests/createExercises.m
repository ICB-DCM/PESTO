...
%CREATEEXERCISES 
    ...
    elseif (contains(mode,'fixeddim'))
        ...
        if (contains(mode,'fixeddim-local'))
            cell_exercises = cell(nTfsFixedDim*C.nSolvers_local*C.nStarts_local,1);
        elseif (contains(mode,'fixeddim-global'))
