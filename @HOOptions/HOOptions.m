    ...
    methods
        ...
        function set.n_obs(this, value)
            if isscalar(value)
                ...
                this.scale = strings(1,this.n_obs);
                this.scaling = strings(1,this.n_obs);
                this.noise = strings(1,this.n_obs);
        ...
        function set.expgroups_noise(this, value)
            if iscell(value)
        ...
        function set.expgroups_scaling(this, value)
            if iscell(value)
        ...
        function set.obsgroups_scaling(this, value)
            if iscell(value)
        ...
        function set.obsgroups_noise(this, value)
            if iscell(value)
        ...
        function set.distribution(this, value)
        ...
        function set.scale(this, value)
            ...
            for i = 1:length(value)
                if strcmp(value(i),'')
                    this.scale(i) = 'lin';
                elseif (strcmp(value(i), 'lin') || strcmp(value(i), 'log') ||...
                        strcmp(value(i), 'log10'))
                    this.scale(i) = value(i);
                else
        ...
        function set.noise(this, value)
            ...
            for i = 1:length(value)
                if strcmp(value(i),'')
                    this.noise(i) = value(i);
                elseif (strcmp(value(i), 'single') || strcmp(value(i), 'multiple') )
                    this.noise(i) = value(i);
                else
        ...
        function set.scaling(this, value)
            ...
            for i = 1:length(value)
                if strcmp(value(i),'')
                    this.scaling(i) = value(i);
                elseif (strcmp(value(i), 'single') || strcmp(value(i), 'multiple')  ||...
                        strcmp(value(i), 'absolute'))
                    this.scaling(i) = value(i);
                else
