% simulate_Pom1p_SDD_model_hess_ft.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_Pom1p_SDD_model_hess_ft(tout,theta)
% [...] = simulate_Pom1p_SDD_model_hess_ft(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_Pom1p_SDD_model_hess_ft(...)
%
% INPUTS:
% =======
...
function varargout = simulate_Pom1p_SDD_model_hess_ft(varargin)
...
sol = ami_Pom1p_SDD_model_hess_ft(tout,theta(1:7),kappa(1:200),options_ami,plist,pbar,xscale,data);
if(options_ami.sensi==1)
