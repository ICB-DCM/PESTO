% simulate_Pom1p_AP_model_hess_ht.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_Pom1p_AP_model_hess_ht(tout,theta)
% [...] = simulate_Pom1p_AP_model_hess_ht(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_Pom1p_AP_model_hess_ht(...)
%
% INPUTS:
% =======
...
function varargout = simulate_Pom1p_AP_model_hess_ht(varargin)
...
sol = ami_Pom1p_AP_model_hess_ht(tout,theta(1:9),kappa(1:400),options_ami,plist,pbar,xscale,data);
if(options_ami.sensi==1)
