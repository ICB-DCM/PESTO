...
parameters_fmincon = runMultiStarts(objectiveFunction, 3, n_starts, 'fmincon', 4, lb, ub);
...
parameters_dhc_old = runMultiStarts(objectiveFunction, 1, n_starts, 'dhc_old', 4, lb, ub);
printResultParameters(parameters_dhc_old);
