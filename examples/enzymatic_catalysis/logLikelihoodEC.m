function [J, gradJ, FIM] = logLikelihoodEC(theta, yMeasured, sigma2, con0, nTimepoints, nMeasure)
...
for iMeasure = 1 : nMeasure
    % Simulation
    [~,X] = ode15s(@(t,x) f(exp(theta),x), t, [con0(:,iMeasure); zeros(16,1)]);
