function parameters = performOptimizationGa(parameters, negLogPost, iMS, options)

    if isempty(which('ga'))
        error('To use ga, the global optimization toolbox must be licensed and installed');
    end
    ...
    parameters.MS.n_iter(iMS)    = output.generations;
