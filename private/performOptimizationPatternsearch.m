function parameters = performOptimizationPatternsearch(parameters, negLogPost, iMS, par0, J_0, options)

    if isempty(which('patternsearch'))
        error('To use patternsearch, the global optimization toolbox must be licensed and installed');
    end
    ...
    [theta,J_opt,exitflag,output] = ...
        patternsearch(negLogPost, ...  % negative log-likelihood function
