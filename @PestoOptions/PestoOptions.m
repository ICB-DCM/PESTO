    ...
    properties
        ...
        SC = struct('proposal_scheme', 'AM', ... %  Random Walk Options  'MH','AM', 'MALA'
                    ...
                    'MALA', struct(...  % MALA options 
                        'min_regularisation', 1e-5, ... % minimal regularistion for hessian matrix
                        'w_hist', 0 ... % interpolation between MALA and AM proposal
                    ), ...
                    'AM', struct( ... % AM options
                        'min_regularisation', 1e-5, ... % minimal regularistion for covariance matrix
                        'init_memory_length', [], ...
                        'adaption_interval', 1, ...
