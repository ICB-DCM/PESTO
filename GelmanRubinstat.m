...
%GELMANRUBIN Computes the R-hat statistic by Gelman and Rubin for a population of Markov chains.
%
% INPUT VARIABLES:
%       chains:     1xn cell containing n parameter objects as used by
%                   PESTO, i.e. chains{1} = parameters etc
...
%   Author: Daniel Schmidl and Sabine Hug
%   Date:   16.10.15
